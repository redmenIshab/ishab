...
- Customer and Business meetings, requirement gathering, cracking deals and agreements with clients` 
  ...
  skills: [
    {
      skillname: "Language: JS, Go, C#, Elixir, Python"
    },
    {
      skillname: "Dev Ops: git, AWS, GCP, Azure "
    },
    {
      skillname: "Database: MySQL, PostgreSQL, MongoDB, CosmosDB"
    },
    {
      skillname: "Operations: Agile, Waterfall, Scrum, Kanban"
    },
    
    {
      skillname: "Industry: US HealthCare, Supply Chain, Hospitality"
    },
    {
      skillname: "Technology: Blockchain, AI, Computer Vision, Cloud"
    },
  ],
    portfolio: [
      {
        "name": "Krane",
        "description": "AI-powered construction logistics platform",
        "webURL": "https://krane.tech"
      },
      {
        "name": "Venteur",
        "description": "Healthcare benefits web application",
        "webURL": "https://venteur.com"
      },
      {
        "name": "Memora Health",
        "description": "Healthcare automation platform",
        "webURL": "https://memorahealth.com"
      },
      {
  ...
  testimonials: [
    {
      description:
        "Ishab's good morale and studies  and his insipiring leadership characteristics across various activities has as all the potential to be a future leader and better person. Wish him luck !",
